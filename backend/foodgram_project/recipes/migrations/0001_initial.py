# Generated by Django 3.2 on 2023-08-31 12:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('units_of_measurement', models.TextField(max_length=200, verbose_name='Единица измерения')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount_of_ingredient', models.PositiveIntegerField(verbose_name='Количество ингредиента')),
