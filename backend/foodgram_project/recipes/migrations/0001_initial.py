# Generated by Django 3.2 on 2023-10-03 15:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', colorfield.fields.ColorField(default='#FFFFFF', error_messages={'unique': 'Тег с таким цветом уже существует!'}, image_field=None, max_length=25, samples=None, unique=True, verbose_name='Цвет(HEX-код)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, related_name='shopping_cart_user', to=settings.AUTH_USER_MODEL, verbose_name='Покупатель')),
            ],
            options={
